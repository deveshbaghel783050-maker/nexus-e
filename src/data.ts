    ...
    customizations: [
      {
        ...
        options: [
          ...
          { name: 'e Red Fiery (Sichuan Style)', price: 0 },
        ]
      }
    ]
  },
...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  {
    id: 'mood',
    text: 'How is the environment of e treating you today?',
    options: [
...
export const MOKAI_GALLERY_SPACES = [
  {
    ...
    spots: [
      { x: 25, y: 35, title: 'Experience e Wall', txt: 'Curated signage detailing Mokai’s journey from a humble local dream to a e coffee sanctuary.' },
      { x: 50, y: 55, title: 'The Photo Frames', txt: 'Local creators showcase! Frames of the workers, the soil creators, and the local e community neighbors.' },
