...
export default function App() {
  ...
  useEffect(() => {
    const cachedCart = localStorage.getItem('e_cart');
    if (cachedCart) {
      try {
    ...
    const cachedBookings = localStorage.getItem('e_bookings');
    if (cachedBookings) {
      try {
  ...
  const saveCart = (newCart: CartItem[]) => {
    setCart(newCart);
    localStorage.setItem('e_cart', JSON.stringify(newCart));
  };
  ...
  const handleAddBooking = (newBooking: TableBooking) => {
    ...
    localStorage.setItem('e_bookings', JSON.stringify(updated));
  };
            ...
            <section className="max-w-5xl mx-auto px-6 space-y-8">
              <div className="text-center max-w-xl mx-auto space-y-2">
                ...
                <p className="text-xs text-brand-outline font-sans">
                  Hover or click on our active visual coordinates to learn the background story of our beautiful e furniture.
                </p>
              </div>
        ...
        {activeTab === 'menu' && (
          <div className="max-w-5xl mx-auto px-6 pt-8 space-y-8 animate-fade-in-up">
            ...
            <div className="text-center max-w-xl mx-auto space-y-2 mb-4">
              ...
              <p className="text-xs text-brand-outline font-sans leading-relaxed">
                From organic edamame purées to slow-whisked Japanese ceremony matcha lattes, everything is made in e.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-brand-outline leading-relaxed font-sans max-w-xs">
              © 2024 e e. Handcrafted using eco-conscious Mumbai local clay and slow artisanal materials.
            </p>
