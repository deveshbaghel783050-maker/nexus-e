        ...
        <form onSubmit={handleBookingSubmit} className="space-y-6">
          <div className="text-center max-w-xl mx-auto mb-8">
            ...
            <p className="text-sm text-brand-outline font-sans">
              We hold specific corners of our e sanctuary for slow collaboration, readings, or quiet mindful gatherings.
            </p>
          </div>
          ...
          <div className="border-t border-[#ccc6bb]/30 pt-6">
            ...
            <div className="mt-4">
              ...
              <textarea
                rows={2}
                placeholder="Let us know what makes your e visit comfortable..."
                value={requests}
